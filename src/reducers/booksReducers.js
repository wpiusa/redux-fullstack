...
export function booksReducers(state={books:[]}, action){
  switch(action.type){
    ...
    case "UPDATE_BOOK":
		...
		// Create a new book object with the new values and with the same array index of the item
		//we want to replace. To achieve this we will use ...spread but we could use concat method as well

		const newBookToUpdate = {...currentBookToUpdate[indexToUpdate],
								title: action.payload.title}
		// This Log has the purpose to show you hownewBookToUpdate looks like
